...
const SignUp = () => {
  return (
    <div className="w-full relative">
      <div
        className="signup-banner w-full h-[230px]  bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url('/Map2.png')" }}
      ></div>
      <div className="bg-white rounded-lg shadow-md p-6 mb-10 absolute top-[150px] left-[50%] translate-x-[-50%] w-[30%]">
        <h1 className="text-2xl text-gary-600 font-semibold mb-4">
          Sign up for Tripma
        </h1>
        ...
        <form>
          ...
          />
          <div className="mb-4">
            <input type="checkbox" id="termsAndConditions" className="mr-2" required />
        ...
        <p className="mt-5 text-gray-500 text-center text-[15px]">
          Already have an account?
          <Link
            to="/signin"
            className="text-[#605DEC] hover:text-[#1513A0] font-semibold"
          >
            {" "}
            Login
          </Link>
